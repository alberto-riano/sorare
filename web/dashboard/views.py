...
def telegram_alerts(request):
    ...
    initial = {
        ...
        "bargain_alert_auction_minutes": initial_source["BARGAIN_ALERT_AUCTION_MINUTES"],
        "valuation_sales_weight": initial_source["VALUATION_SALES_WEIGHT"],
        "valuation_parity_weight": initial_source["VALUATION_PARITY_WEIGHT"],
        "valuation_floor_weight": initial_source["VALUATION_FLOOR_WEIGHT"],
        ...
        if form.is_valid():
            ...
            save_telegram_alert_payload(
                PATHS,
                {
                    ...
                    "BARGAIN_ALERT_AUCTION_MINUTES": str(data["bargain_alert_auction_minutes"]),
                    "VALUATION_SALES_WEIGHT": str(data["valuation_sales_weight"]),
                    "VALUATION_PARITY_WEIGHT": str(data["valuation_parity_weight"]),
                    "VALUATION_FLOOR_WEIGHT": str(data["valuation_floor_weight"]),
