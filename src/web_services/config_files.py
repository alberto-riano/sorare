...
DEFAULT_TELEGRAM_SETTINGS = {
    ...
    "BARGAIN_ALERT_ENABLED": "false",
    "BARGAIN_ALERT_MIN_SAVING_PERCENT": "40",
    "BARGAIN_ALERT_AUCTION_MINUTES": "10",
    "VALUATION_SALES_WEIGHT": "3",
    "VALUATION_PARITY_WEIGHT": "2",
    "VALUATION_FLOOR_WEIGHT": "1",
    "NOTIFY_MODE": "all",
    "NOTIFY_DROP_EUR": "1.0",
...
SETTINGS_ORDER = [
    ...
    "BARGAIN_ALERT_ENABLED",
    "BARGAIN_ALERT_MIN_SAVING_PERCENT",
    "BARGAIN_ALERT_AUCTION_MINUTES",
    "VALUATION_SALES_WEIGHT",
    "VALUATION_PARITY_WEIGHT",
    "VALUATION_FLOOR_WEIGHT",
    "NOTIFY_MODE",
    "NOTIFY_DROP_EUR",
